...
/* DIN MIDI */
#define MIDI_CHANNEL 1 // hard-coded for now
...
#define NUM_SYNTH_PARAMS 64 // currently less, but reserve 64 values in presets
#define NUM_VOICES 4
...
/* Helpers */
#define OUTPUT_LOWPASS 0
#define OUTPUT_BANDPASS 1
#define OUTPUT_HIGHPASS 2
